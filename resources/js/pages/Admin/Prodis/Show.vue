...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: props.prodi.nama, href: `/admin/prodis/${props.prodi.id}` },
];
...
<template>
    <Head :title="`${prodi.nama}`" />
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="space-y-6 p-4 sm:p-6">
            <!-- Header -->
            <div class="flex items-center gap-4">
                <Link href="/admin/prodis" as="button">
                    <Button variant="outline" size="sm">
                        <ArrowLeft class="h-4 w-4" />
                    </Button>
                </Link>
                <div>
                    <h1 class="text-3xl font-bold">{{ prodi.nama }}</h1>
            ...
            <div class="grid gap-6 lg:grid-cols-3">
                ...
                <div class="space-y-6">
                    ...
                    <div class="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-900">
                        ...
                        <div class="mt-4 space-y-4">
                            <div>
                                ...
                                <div class="mt-2">
                                    <span :class="['inline-block rounded-full px-3 py-1 text-xs font-semibold', getStatusBadge(prodi.is_active)]">
                        ...
                        <div class="mt-4 space-y-4 text-sm">
                            <div>
                                ...
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                    {{ new Date(prodi.created_at).toLocaleString('id-ID') }}
                                </p>
                            </div>
                            <div>
                                <label class="font-medium text-gray-600 dark:text-gray-400">Diperbarui</label>
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                    {{ new Date(prodi.updated_at).toLocaleString('id-ID') }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Actions -->
                    <div class="space-y-2">
                        <Link :href="`/admin/prodis/${prodi.id}/edit`" as="button">
