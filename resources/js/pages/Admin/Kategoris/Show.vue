...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: props.kategori.nama, href: `/admin/kategoris/${props.kategori.id}` },
];
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="space-y-6 p-4 sm:p-6">
            ...
            <div class="flex items-center gap-4">
                <Link href="/admin/kategoris" as="button">
                    <Button variant="outline" size="sm">
                        <ArrowLeft class="h-4 w-4" />
                    </Button>
                </Link>
                <div>
                    <h1 class="text-3xl font-bold">{{ kategori.nama }}</h1>
            ...
            <div class="grid gap-6 lg:grid-cols-3">
                ...
                <div class="space-y-6">
                    ...
                    <div class="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-900">
                        ...
                        <div class="mt-4 space-y-4">
                            <div>
                                ...
                                <div class="mt-2">
                                    <span :class="['inline-block rounded-full px-3 py-1 text-xs font-semibold', getStatusBadge(kategori.is_active)]">
                    ...
                    <!-- Actions -->
                    <div class="space-y-2">
                        <Link :href="`/admin/kategoris/${kategori.id}/edit`" as="button">
